...
#Created own ascii plaque function
...
while option == False:
    if x == 1:
        ...
        x=int(input( str(x) + " is not an existing option. Please try again. Enter 1 or 2 to indicate your option\n"))
